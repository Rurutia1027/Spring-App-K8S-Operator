...
type SpringAppSpec struct {
	...
	// foo is an example field of SpringApp. Edit springapp_types.go to remove/update
	// +optional
...
type SpringAppStatus struct {
	...
	// conditions represent the current state of the SpringApp resource.
...
func init() {
	SchemeBuilder.Register(func(s *runtime.Scheme) error {
		s.AddKnownTypes(SchemeGroupVersion, &SpringApp{}, &SpringAppList{})
		return nil
	})
}
